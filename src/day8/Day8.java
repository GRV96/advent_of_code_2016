...
class Day8
{
    ...
    public static void main(String[] pArgs) throws IOException
    {
        ...
        while ((inputLine = reader.readLine()) != null)
        {
            ...
            {
                case CMD_RECT -> parseRectCommand(screen, splitCommand);
                case CMD_ROTATE -> parseRotateCommand(screen, splitCommand);
            }
        }
    ...
    private static void parseRectCommand(Screen pScreen, String[] pSplitCommand)
    {
    ...
    private static void parseRotateCommand(Screen pScreen, String[] pSplitCommand)
    {
